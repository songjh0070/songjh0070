			...
			<div class = "goods_contents_area">
				...
				<div class = "goods_info_area">
					...
					<div class ="goods_price">
						<input value ="<%=normal_price%>"name="origin_price" class = "price" id = "origin_price" style= "font-size :35px; outline : none; border : none; padding : 0; font-weight : bold; display : inline-block; width : 100px;" value = "<%=normal_price%>"><span style = "font-weight : bold; font-size : 35px; ">원</span>
						<div class = "one_pack">
							<%= each %>
						</div>
